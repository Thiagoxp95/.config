...
-- Set new mark with harpoon with cntrl+m that exexutes :lua require("harpoon.mark").add_file()
maps.n["<C-m>"] = { function() require("harpoon.mark").add_file() end, desc = "Add file to harpoon" }

-- View all marks with Ctrl+shift+m that executes :lua require("harpoon.ui").toggle_quick_menu()
maps.n["<C-S-m>"] = { function() require("harpoon.ui").toggle_quick_menu() end, desc = "View all harpoon marks" }

-- navigate to the next mark using leader arrow up that executes :lua require("harpoon.ui").nav_next()                   -- navigates to next mark
maps.n["<leader><up>"] = { function() require("harpoon.ui").nav_next() end, desc = "Navigate to next harpoon mark" }

-- navigate to the previous mark using leader arrow down that executes :lua require("harpoon.ui").nav_prev()
maps.n["<leader><down>"] = { function() require("harpoon.ui").nav_prev() end, desc = "Navigate to previous harpoon mark" }
